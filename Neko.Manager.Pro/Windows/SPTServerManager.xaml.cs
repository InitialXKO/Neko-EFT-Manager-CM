...
namespace Neko.EFT.Manager.X.Windows
{
    ...
    /// </summary>
    public sealed partial class SPTServerManager : Window
    {
        ...
        public SPTServerManager()
        {
            ...
            ContentFrame.Navigate(typeof(ServerAOPage), null, new SuppressNavigationTransitionInfo());
        ...
        private async void NavView_Navigate(NavigationViewItem item)
        {
            ...
            switch (item.Tag)
            {
                ...
                //    break;
                case "Server":
                    ContentFrame.Navigate(typeof(NekoServerPage));
                    break;
                case "ServerTools":
                    ContentFrame.Navigate(typeof(ServerToolsPage));
                    break;
                case "ConfigServer":
                ...
                case "ProfileManager":
                    ...
                    Debug.WriteLine("Navigating to ProfileManagerPage");
                    ContentFrame.Navigate(typeof(ProfileManagerPage));
                    break;
                case "ServerOneClick":
                    ContentFrame.Navigate(typeof(ServerAOPage));
                    break;
