    ...
    public sealed partial class LocationEditor : Page
    {
        ...
        private async void LoadButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (File.Exists(file.Path))
            {
                ...
                if (location == null)
                {
                    await Utils.ShowInfoBar("Load Error", "There was an error saving the file.", InfoBarSeverity.Error);
                    return;
                }
        ...
        private async void SaveButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
               await  Utils.ShowInfoBar("Save Error", "There was an error saving the file.", InfoBarSeverity.Error);
                return;
            }
            ...
            await Utils.ShowInfoBar("Save", $"Successfully saved the file to: {file.Path}", InfoBarSeverity.Success);
        }
